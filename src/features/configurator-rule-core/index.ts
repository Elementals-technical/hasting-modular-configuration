...
export const applyConfiguratorRules = (selection: Selection, intent?: Intent): ApplyRulesResult => {
  const context: RuleContext = { selection: { ...selection, width: Number(selection.width) } };
